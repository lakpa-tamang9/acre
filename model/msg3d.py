...
from utils.model_utils import import_class, count_params
...
if __name__ == "__main__":
    ...
    model = Model(
        ...
        num_gcn_scales=13,
        num_g3d_scales=6,
        graph="graph.mediapipe.AdjMatrixGraph",
    )

    # V: Number of nodes/vertex (13 for our case), C: No. of Channels, T : Number of frames
    # FOr NTU-RGB dataset, number of nodes = 25
    N, C, T, V, M = 6, 3, 50, 13, 1
